...
class Ps_FeaturedProducts extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->trans('Pick a category and highlight its items, enhance customer experience with a lively homepage.', array(), 'Modules.Featuredproducts.Admin');
